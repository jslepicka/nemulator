...
export class c_system_container : public c_texture_panel_item
{
  public:
    ...
    bool Selectable();
    bool mask_sides;
    bool limit_sprites; //applied when the system is created, from settings > system
    ...
    bool has_sprite_limit() { return system_info.has_sprite_limit; }
    bool has_disk_indicator() { return system_info.has_disk_indicator; }
