        ...
        while (true) {
            if (fetch_opcode) {
                ...
                if (required_cycles == 0) {
                    ...
                    //opcode, ins_start); MessageBox(NULL, txt, "oops", MB_OK); exit(0);
                }
                if (pending_ei) {
                    pending_ei = 0;
                    IME = 1;
...
// clang-format off
alignas(64) static constexpr c_sm83::s_ins ins_info[517] = {
