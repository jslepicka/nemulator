...
{
	if (g_ih->get_result(c_nes_input_handler::BUTTON_1DOWN, true) & c_input_handler::RESULT_DOWN ||
		g_ih->get_result(c_nes_input_handler::BUTTON_1SELECT, true) & c_input_handler::RESULT_DOWN)
	{
		selected_item = ++selected_item % menu_items->num_items;
	}
	else if (g_ih->get_result(c_nes_input_handler::BUTTON_1UP, true) & c_input_handler::RESULT_DOWN)
	{
		selected_item--;
		if (selected_item < 0)
			selected_item = menu_items->num_items - 1;
	}
	else if (g_ih->get_result(c_nes_input_handler::BUTTON_1A, true) & c_input_handler::RESULT_DOWN ||
		g_ih->get_result(c_nes_input_handler::BUTTON_1START, true) & c_input_handler::RESULT_DOWN ||
	...
	else if ((g_ih->get_result(c_nes_input_handler::BUTTON_1B, true) & c_input_handler::RESULT_DOWN) ||
